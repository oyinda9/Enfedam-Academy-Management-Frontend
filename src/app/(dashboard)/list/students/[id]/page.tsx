      ...
      <div className="w-full xl:w-1/3   rounded-md mb-6">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-sm text-gray-800">
            <Link className="p-3 rounded-md bg-pink-200" href={`/list/teachers?classId=${2}`}>
              {" "}
              Student&apos;s Teachers
            </Link>
            <Link className="p-3 rounded-md bg-yellow-200" href={`/list/lessons?classId=${2}`}>
              {" "}
              Student&apos;s Lessons
            </Link>
            <Link className="p-3 rounded-md bg-purple-200" href={`/list/exams?classId=${2}`}>
              {" "}
              Student&apos;s Exams
            </Link>
            <Link className="p-3 rounded-md bg-green-200" href={`/list/assignments?classId=${2}`}>
              {" "}
              Student&apos;s Assignments
            </Link>
            <Link className="p-3 rounded-md bg-blue-200" href={`/list/results?studentId=${"student2"}`}>
              {" "}
              Student&apos;s Results
            </Link>
          </div>
